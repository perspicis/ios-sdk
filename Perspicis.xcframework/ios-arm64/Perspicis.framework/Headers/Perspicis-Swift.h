...
#ifndef PERSPICIS_SWIFT_H
#define PERSPICIS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Perspicis",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9Perspicis19PerspicisBannerView")
@interface PerspicisBannerView : UIView
...
SWIFT_CLASS("_TtC9Perspicis10VASTParser")
...
@class NSXMLParser;
@class NSString;
@interface VASTParser (SWIFT_EXTENSION(Perspicis)) <NSXMLParserDelegate>
